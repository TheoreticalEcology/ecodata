...
devtools::use_data(nitrofen, pkg = "../EcoData/.", overwrite = T)
```
...
devtools::use_data(melanoma, pkg = "../EcoData/.", overwrite = T)
...
devtools::use_data(arthritis, pkg = "../EcoData/.", overwrite = T)
```
...
devtools::use_data(rikz, pkg = "../EcoData/.", overwrite = T)
```
...
devtools::use_data(streams, pkg = "../EcoData/.", overwrite = T)
```
...
devtools::use_data(cement, pkg = "../EcoData/.", overwrite = T)
```
...
devtools::use_data(plantcounts, pkg = "../EcoData/.", overwrite = T)
```
...
devtools::use_data(anolisData, pkg = "../EcoData/.", overwrite = T)
devtools::use_data(anolisTree, pkg = "../EcoData/.", overwrite = T)
```
...
devtools::use_data(snouter, pkg = "../EcoData/.", overwrite = T)
```
