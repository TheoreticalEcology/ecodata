...
str(birdfeeding)
usethis::use_data(birdfeeding, pkg = "../EcoData/.", overwrite = T)
...
usethis::use_data(titanic, pkg = "../EcoData/.", overwrite = T)
...
usethis::use_data(birdabundance, pkg = "../EcoData/.", overwrite = T)
```
...
usethis::use_data(regrowth, pkg = "../EcoData/.", overwrite = T)
```
...
usethis::use_data(solomonislands, pkg = "../EcoData/.", overwrite = T)
```
...
usethis::use_data(students, pkg = "../EcoData/.", overwrite = T)
```
...
usethis::use_data(nitrofen, pkg = "../EcoData/.", overwrite = T)
```
...
usethis::use_data(melanoma, pkg = "../EcoData/.", overwrite = T)
...
usethis::use_data(arthritis, pkg = "../EcoData/.", overwrite = T)
```
...
usethis::use_data(rikz, pkg = "../EcoData/.", overwrite = T)
```
...
usethis::use_data(streams, pkg = "../EcoData/.", overwrite = T)
```
...
usethis::use_data(cement, pkg = "../EcoData/.", overwrite = T)
```
...
usethis::use_data(plantcounts, pkg = "../EcoData/.", overwrite = T)
```
...
```{r}
anolisData <- read.csv("./RawData/anolisDataAppended.csv", row.names = 1)
anolisTree <- ape::read.tree("./RawData/anolis.phy")
usethis::use_data(anolisData, pkg = "../EcoData/.", overwrite = T)
usethis::use_data(anolisTree, pkg = "../EcoData/.", overwrite = T)
```
...
```{r}
snouter <- read.table("./RawData/snouterdata.txt", header=T, sep="\t")
usethis::use_data(snouter, pkg = "../EcoData/.", overwrite = T)
```
...
usethis::use_data(volcanoisland, pkg = "../EcoData/.", overwrite = T)
