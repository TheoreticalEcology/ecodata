...
```{r}
bees = read.csv("./RawData/Bees.txt")
save(bees, file = "../EcoData/Data/bees.Rdata")
```
...
save(anolisData, file = "../EcoData/Data/anolisData.Rdata")
save(anolisTree, file = "../EcoData/Data/anolisTree.Rdata")
```
...
save(snouter, file = "../EcoData/Data/snouter.Rdata")
```
