...
str(soep)
soep$sex <- as.factor(soep$sex)
soep$erwerb <- as.factor(soep$erwerb)
soep$branche <- as.factor(soep$branche)
soep$gesund_org <- as.factor(soep$gesund_org)
soep$lebensz_org <- as.factor(soep$lebensz_org)
str(soep)
...
load("elk_data.RData")
elk = elk_data
usethis::use_data(elk, overwrite = T)
```
