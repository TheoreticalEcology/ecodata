...
```{r}
snails = readRDS("data-raw/snails.RDS")
...
```{r}
library(dplyr)
variables = readxl::read_xlsx("data-raw/Rosbakh et al. 2022_JEcol_traits.xlsx", sheet = 2)
SB = readxl::read_xlsx("data-raw/Rosbakh et al. 2022_JEcol_traits.xlsx", sheet = 4)
additional_variables = readRDS("data-raw/Seed_env_variables.RDS")
...
```{r}
library(dplyr)
data = readxl::read_xlsx("data-raw/Rosbakh_2021_C_N.xlsx", sheet = 1)
